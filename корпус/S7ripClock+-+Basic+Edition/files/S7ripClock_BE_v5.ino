// S7ripClock - Basic Edition - Software update v5 / Initial Release
// 02/2020 Daniel Cikic
...
byte brightnessLevels[3] {100, 160, 230};        // 0 - 255, brightness Levels (min, med, max) - index (0-2) will get stored to eeprom
...
void setupClock() {
  ...
  setupTime.Day = 14;                                                                       // not really neccessary as day/month aren't used but who cares ^^
